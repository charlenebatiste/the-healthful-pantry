		...
		<div className="about__wrapper p-2">
			...
			<div className="about__content mx-5 ">
				<p className="about__text text-start">
					...
					and education to take back
					their lives. Healthful Pantry
					gives you back the power to
					control your health on your
					own terms - skipping the need
					to see a nutritionist or
					dietician. Our goal is to save
					you money, time, and most
